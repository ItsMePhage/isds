                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-12 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="form-validation" novalidate>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <textarea name="reasons" class="form-control form-control-sm" id="reasons"
                                            maxlength="150" readonly></textarea>
                                    </div>
    ...
    <script>
        $.ajax({
            ...
            success: function (response) {
                ...
                $('.crit1 button[data-value="' + response.criteria_a + '"]').addClass('text-warning');
                $('.crit2 button[data-value="' + response.criteria_b + '"]').addClass('text-warning');
                $('.crit3 button[data-value="' + response.criteria_c + '"]').addClass('text-warning');
                $('.crit4 button[data-value="' + response.criteria_d + '"]').addClass('text-warning');
                $('.overall button[data-value="' + response.overall + '"]').addClass('text-warning');
